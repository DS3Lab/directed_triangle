...
import ch.ethz.ml.graph.trianglecount.{EdgeIterDirected, EdgeIterPlusDirected, EdgeIterPlusUndirected, EdgeIterUndirected, FastDirected, FastDirectedV2, FastUndirected, NodeIterDirected, NodeIterPlusDirected, NodeIterPlusUndirected, NodeIterUndirected}
import ch.ethz.ml.graph.utils.ArgsUtil
import org.apache.spark.sql.SparkSession
import org.apache.spark.storage.StorageLevel

object DirectedRunner {
